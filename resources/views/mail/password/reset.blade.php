        ...
        <div class="container">
            <div class="logo-sec">
                ...
                <div class="sec-cont">
                    ...
                    <div class="cnt-outer">
                        <h6>Hey <b>{{ $name }},</b></h6>
                        <p>Forgot Your Password? No problem! As Per your Request we have genarated passcode inorder to change your password securely.</p>
                        <p>Please use the 6 digits code below to verify and process password reset.</p>
                        <span class="digits" style="font: 700 20px 'Syncopate';letter-spacing: 3px;">{{ $token }}</span>
                        <p>On the FindOD App, you will be able to enter and confirm your new password.</p>
