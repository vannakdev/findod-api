        ...
        <div class="container">
            <div class="logo-sec">
                ...
                <div class="sec-cont">
                    ...
                    <div class="cnt-outer">
                        <h6>Hey <b>{{ $name }},</b></h6>
                        <p>Your findOD account was Deactivated</p>
                        <p>When you Deactivate your account, your profile and all listings will no longer appear on the FindOD site. Any Action you have made as a host or a guest will automatically be canceled. You can contact us anytime If You need any Assistance.</p>
                       <ul class="scl-login">
                            <p>Open FindOD App</p>
