...
//create new report_property object and assign value from request's data
    ...
    public function showAll() {
        $report = \App\TypeOfPropertyReportTranslation::where('locale', '=', app('translator')->getLocale())->get();
        if (!$report) {
            return $this->getResponseData("0", "Report type not found with given property ID", "");
        }
        return $this->getResponseData("1",'', $report);
    }
